...
poster = Rule("<div class=\"poster\">(.*?)id=\"yk_app_sum\">")
IMG = Rule("src=\"(.*?)\"")
...
am = Rule("")
# 剧集
pages = Rule("/drama/[A-Za-z]+/episode/[0-9]+-[0-9]+\"|/drama/[A-Za-z]+/episode/dajieju\"")
pages2 = Rule("/drama/[A-Za-z]+/episode/[0-9]+-[0-9]+\" title=\".*?</a>|/drama/[A-Za-z]+/episode/dajieju\" title=\".*?</a>")
